...
export const MollierDiagram: React.FC<MollierDiagramProps> = ({ canvasExportRef }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`h-9 px-2.5 py-1 border-b flex items-center justify-between gap-2 shrink-0 z-50 transition-colors whitespace-nowrap overflow-visible relative ${
